...
def quadrat():
    ...
    text(img, (m, H - m - 34), "katzenufos.com", font(24), MUTED, track=0.6)
    text(img, (W - m, H - m - 39), "CHF 39.90", font(30, True), TEXT, anchor="rs")
...
def story():
    ...
    text(img, (W - m, 1508), "CHF 39.90", font(44, True), TEXT, anchor="rs")
    text(img, (W - m, 1562), "katzenufos.com", font(28), MUTED,
         track=0.6, anchor="rs")
...
def link():
    ...
    text(img, (m, H - m - 32), "katzenufos.com", font(23), MUTED, track=0.6)
    text(img, (640, H - m - 37), "CHF 39.90", font(29, True), TEXT, anchor="rs")
