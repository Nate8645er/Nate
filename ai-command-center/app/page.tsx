      ...
      <main className="flex-1">
        ...
        <section id="werbespot" className="scroll-mt-24 border-t border-[#e8e1d2] px-6 py-24">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-10 overflow-hidden rounded-2xl border border-[#1c1917]/10 bg-[#07070d] shadow-[0_30px_90px_-30px_rgba(28,25,23,0.6)]">
              <video
                autoPlay
                muted
                loop
            ...
            <p className="mt-3 text-center text-xs text-[#7c7161]">
              Animierter Marken-Spot (im Haus produziert). Die tatsächliche Oberfläche
