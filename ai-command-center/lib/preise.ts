...
export const PAKETE: readonly Paket[] = [
  ...
  },
  {
    ...
    leistungen: [
      ...
      "On-Premise oder Private Cloud – Ihre Daten verlassen das Haus nie",
      "Eigene, lokale Modelle (kein Anbieter-Lock-in) statt fremder Cloud-KI",
      "Mandantentrennung auf DB-Ebene, SSO-Login, lückenloses Audit-Log",
      "Individuelle Integrationen (ERP/CRM, SSO, Maschinen), SLA & Begleitung",
    ],
