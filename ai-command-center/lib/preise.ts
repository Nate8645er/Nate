...
export const PAKETE: readonly Paket[] = [
  {
    ...
    leistungen: [
      ...
      "Ergebnisse mit Qualitäts-Score",
    ],
    cta: "Basic wählen",
  },
  {
    ...
    leistungen: [
      ...
      "Alle Firmen-Integrationen (M365, Google, Slack, Shopify, Stripe …)",
      "Eigene Workflows & Freigaben",
  ...
  },
  {
    ...
    leistungen: [
      ...
      "Alle Skills + KI-Strategie",
      "Private Cloud oder On-Premise",
      "SLA & Sicherheit nach Mass",
      "Persönliche Begleitung & Schulung",
    ],
